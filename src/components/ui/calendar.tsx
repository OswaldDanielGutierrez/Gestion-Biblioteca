  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary text-neutral-50 hover:bg-blue-200 hover:text-neutral-50 focus:bg-primary focus:text-neutral-50 dark:bg-primary dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900",
        day_today:
          "bg-blue-200 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-50",
        day_outside:
